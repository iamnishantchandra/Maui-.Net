...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 769960038274945081, ; hash 0xaaf72934c9fd039, from name: MauiTutorial.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiTutorial.dll.so
		ptr null; void* handle (0x0)
	}, ; 21
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 10740391791889865696, ; hash 0x950d896e001ddbe0, from name: aot-MauiTutorial
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiTutorial.dll.so
		ptr null; void* handle (0x0)
	}, ; 266
	...
	%struct.DSOCacheEntry {
		i64 11421094512858439984, ; hash 0x9e7fe0f2a9172130, from name: MauiTutorial
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiTutorial.dll.so
		ptr null; void* handle (0x0)
	}, ; 286
	...
	%struct.DSOCacheEntry {
		i64 13567710645829083564, ; hash 0xbc4a30f293eda1ac, from name: libaot-MauiTutorial.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiTutorial.dll.so
		ptr null; void* handle (0x0)
	}, ; 351
	...
	%struct.DSOCacheEntry {
		i64 14038425332868422787, ; hash 0xc2d2817623779c83, from name: aot-MauiTutorial.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiTutorial.dll.so
		ptr null; void* handle (0x0)
	}, ; 367
	...
	%struct.DSOCacheEntry {
		i64 18010014090169394738, ; hash 0xf9f06c64d453a632, from name: libaot-MauiTutorial
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiTutorial.dll.so
		ptr null; void* handle (0x0)
	}, ; 461
...
@.env.3 = private unnamed_addr constant [37 x i8] c"60e781c8-a0f7-443d-a7d8-6097ad1a5707\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [29 x i8] c"com.companyname.mauitutorial\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [27 x i8] c"libaot-MauiTutorial.dll.so\00", align 16
