...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 348153674, ; hash 0x14c0674a, from name: libaot-MauiTutorial.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 538901048, ; hash 0x201efa38, from name: MauiTutorial
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiTutorial.dll.so
		ptr null; void* handle (0x0)
	}, ; 55
	...
	%struct.DSOCacheEntry {
		i64 1612987577, ; hash 0x60243cb9, from name: aot-MauiTutorial.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiTutorial.dll.so
		ptr null; void* handle (0x0)
	}, ; 167
	...
	%struct.DSOCacheEntry {
		i64 2799115154, ; hash 0xa6d71b92, from name: libaot-MauiTutorial
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiTutorial.dll.so
		ptr null; void* handle (0x0)
	}, ; 314
	...
	%struct.DSOCacheEntry {
		i64 3520096576, ; hash 0xd1d06940, from name: MauiTutorial.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiTutorial.dll.so
		ptr null; void* handle (0x0)
	}, ; 395
	...
	%struct.DSOCacheEntry {
		i64 3898102417, ; hash 0xe8585291, from name: aot-MauiTutorial
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiTutorial.dll.so
		ptr null; void* handle (0x0)
	}, ; 435
